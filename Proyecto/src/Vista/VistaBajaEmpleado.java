 ...
 * @author limberth
 */
public class VistaBajaEmpleado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Empleado no encontrado.");
        ...
        jLabel13.setText("Empleado eliminado.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaBajaEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaBajaEmpleado().setVisible(true);
            }
        });
    }
