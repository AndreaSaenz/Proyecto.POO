 ...
 * @author limberth
 */
public class VistaBajaVenta extends javax.swing.JFrame {

    /**
     * Creates new form BajaCliente
     */
    public VistaBajaVenta() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaBajaVenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaBajaVenta().setVisible(true);
            }
        });
    }
